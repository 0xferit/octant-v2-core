...
import { BaseYieldSkimmingIntegrationTest } from "../../YieldSkimming/base/BaseYieldSkimmingIntegrationTest.sol";
...
/// @title BasePrivilegedYieldSkimmingIntegrationTest
/// @notice Base contract for privileged yield skimming strategy integration tests
/// @dev Combines YieldSkimming base tests with privileged access control tests
abstract contract BasePrivilegedYieldSkimmingIntegrationTest is
    BaseYieldSkimmingIntegrationTest,
    BasePrivilegedIntegrationTest
{
    ...
    /// @dev Override for BasePrivilegedIntegrationTest
    function _minDeposit() internal view virtual override returns (uint256);

    /// @dev Override for BasePrivilegedIntegrationTest
    function _maxDeposit() internal view virtual override returns (uint256);
